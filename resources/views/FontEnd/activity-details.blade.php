...
<html lang="eng">
<head>
	<title>Unique Coaching Center</title>
	<!-- meta-tags -->
...
<body>
			...
			<div class="bottom_header_left">
				<p>
					<span class="fa fa-map-marker" aria-hidden="true">
						</span>Moriyom Manshan,Rashid Colony,Maijdee,Noakhali,Chittagong,Bangladesh
				</p>
			</div>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html">
							<h1>
								<span class="fa fa-leanpub" aria-hidden="true">
									</span>Unique Coaching Center
					...
					<div class="three_testimonials_grid_main">
						<div class="col-xs-3 three_testimonials_grid_pos">
							<div class="grid-test-allah-agile">
								<img src="{{asset('piublic/assets/images/te1.jpg')}}" alt=" " class="img-responsive" />
							</div>
						</div>
	...
	<script src="public/assets/js/numscroller-1.0.js"></script>
	<!-- //stats numscroller-js-file -->
	...
	<script src="public/assets/js/jquery.flexisel.js"></script>
	<!-- //Flexslider-js for-testimonials -->
	<!-- smooth scrolling -->
	<script src="public/assets/js/SmoothScroll.min.js"></script>
	<script src="public/assets/js/move-top.js"></script>
